...
import { Plus, MessageSquare, HelpCircle, Settings, CheckCircle2, ChevronRight, TrendingUp, Calendar, AlertCircle } from "lucide-react";
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          ...
          <div className="bg-white/60 backdrop-blur-xl border border-white border-b-white/40 shadow-[0_8px_30px_rgba(0,0,0,0.04)] rounded-[2.5rem] p-6 h-64 flex flex-col">
            <div className="flex justify-between items-center mb-4">
              <div>
                <h3 className="text-lg font-bold text-slate-800">Lista de Tarefas</h3>
                <p className="text-sm text-slate-500">Quarta-feira, 11 Mai</p>
              </div>
              <button className="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center text-slate-600">
            ...
            <div className="bg-white rounded-3xl p-5 shadow-sm border border-slate-100 flex-1 flex flex-col justify-between">
              <div>
                <div className="flex justify-between items-start mb-1">
                  <h4 className="font-semibold text-slate-800 line-through text-slate-400">Levantamento de Evidências</h4>
                  <div className="w-6 h-6 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center">
                    <CheckCircle2 size={14} />
                  </div>
                </div>
                <p className="text-sm text-slate-500">Domínio A - Independência</p>
              </div>

              <div className="flex justify-between items-center pt-4 border-t border-slate-50">
                <span className="text-xs font-medium text-slate-400 flex items-center gap-1">
                  <Calendar size={12} /> Hoje 10:00 - 11:45
                </span>
                <div className="flex -space-x-2">
                  <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=100&auto=format&fit=crop" className="w-6 h-6 rounded-full border-2 border-white" />
                  <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=100&auto=format&fit=crop" className="w-6 h-6 rounded-full border-2 border-white" />
                </div>
              </div>
            </div>
          </div>
